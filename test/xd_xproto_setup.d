/*
 * dmd -unittest xproto.d core.d util.d -run test/xd_xproto_setup.d
 */
...
// TODO: dump `main()` in favor of a test framework
void main()
{
}
...
unittest
{
	...
	assert (setup.roots[0].allowed_depths == [
			Depth(24, 0, 71, 0, [
...
unittest
{
	...
	assert (setup.roots[0].allowed_depths[0].visuals == [
			VisualType(0x23, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x24, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x25, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x26, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x27, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x28, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x29, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x2a, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x2b, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x2c, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x2d, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x2e, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x2f, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x30, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x31, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x32, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x33, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x34, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x35, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x36, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x37, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x38, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x39, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x3a, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x3b, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x3c, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x3d, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x3e, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x3f, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x40, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x41, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x42, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x43, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x44, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x45, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x46, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x47, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x48, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x49, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x4a, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x4b, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x4c, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x4d, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x4e, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x4f, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x50, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x51, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x52, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x53, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x54, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x55, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x56, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x57, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x58, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x59, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x5a, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x5b, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x5c, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x5d, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x5e, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x5f, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x60, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x61, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x62, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x63, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x64, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x65, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x66, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x67, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x68, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x69, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x6a, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x6b, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x6c, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x6d, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x6e, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x6f, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x70, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x71, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF),
			VisualType(0x72, 5, 8, 256, 0xFF0000,0x00FF00,0x0000FF)]);
	...
	assert (setup.roots[0].allowed_depths[6].visuals == [
			VisualType(0x85, 4, 8, 256, 0xFF0000,0x00FF00,0x0000FF)]);
	writeln("test 2 [done]");
}
